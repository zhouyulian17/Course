...
class Cluster(object):
    ...
    def averageLinkageDist(self, other):
        ...
        for p1 in self.points:
            for p2 in other.points:
                totalD += p1.distance(p2)
                num += 1
        return float(totalD) / num
...
class ClusterSet(object):
    ...
    def mergeClusters(self, c1, c2):
        ...
        c3 = Cluster(c1.points + c2.points, c1.pointType)
        newClusters = [cluster for cluster in self.getClusters() 
                       if cluster != c1 and cluster != c2]
        newClusters.append(c3)
        self.members = newClusters
...
def test():
    points = buildCityPoints('/Users/yulianzhou/Desktop/Course/python/6002x/ProblemSet6/cityTemps.txt', False)
    ...
    points1 = buildCityPoints('/Users/yulianzhou/Desktop/Course/python/6002x/ProblemSet6/cityTemps.txt', True)
    hCluster(points1, Cluster.singleLinkageDist, 5, False)
    #points = buildCityPoints('/Users/yulianzhou/Desktop/Course/python/6002x/ProblemSet6/test.txt', False)
