...
WORDLIST_FILENAME = "/Users/yulianzhou/Desktop/course/python/6001x/ProblemSet4/words.txt"
...
def updateHand(hand, word):
    ...
    return {i:newhand[i] for i in newhand if newhand.get(i) != 0}
